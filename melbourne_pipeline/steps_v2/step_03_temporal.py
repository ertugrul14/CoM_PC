...
def _build_weather() -> pd.DataFrame:
    ...
    # weather_raw.time is now naive Melbourne local (fetched with timezone=
    # Australia/Melbourne); utc=True relabels it onto the same Melbourne-wall-
    # clock-as-UTC axis as the activity data, so the merge aligns (D-011).
